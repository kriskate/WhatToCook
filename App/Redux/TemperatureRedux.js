...
export const request = (state: Object, { city }: Object) =>
  state.merge({ fetching: true, city, temperature: null,abc:1 })

// successful temperature lookup
export const success = (state: Object, action: Object) => {
  const { temperature } = action
  return state.merge({ fetching: false, error: null, temperature,abc:1 })
}

// failed to get the temperature
export const failure = (state: Object) =>
  state.merge({ fetching: false, error: true, temperature: null,abc:1 })
